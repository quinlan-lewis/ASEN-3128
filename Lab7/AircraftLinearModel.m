...
Mde = (1/2)*rho*u0^2*ap.S*ap.c*Cmde;
...
Blon(1,:) = [Xde/m, Xdt/m];
Blon(2,:) = [Zde/(m-Zwdot), Zdt/(m-Zwdot)];
Blon(3,:) = [Mde/Iy+Mwdot*Zde/(Iy*(m-Zwdot)), Mdt/Iy+Mwdot*Zdt/(Iy*(m-Zwdot))];
Blon(4:6,:) = [0 0;0 0; 0 0];
...
Blat(1,:) = [0, Ydr/m];
Blat(2,:) = [G3*Lda+G4*Nda, G3*Ldr+G4*Ndr];
Blat(3,:) = [G4*Lda+G8*Nda, G4*Ldr+G8*Ndr];
Blat(4:6,:) = [0, 0;0 0; 0 0];
